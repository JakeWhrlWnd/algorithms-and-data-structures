...
//Create an object to contain the songs, current song playing, and time of current song
let userData = {
    //Using the spread operator to copy the allSongs array without mutation
    songs: [...allSongs],
    currentSong: null,
    songCurrentTime: 0,
};
